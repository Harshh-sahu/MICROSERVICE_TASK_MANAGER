    ...
    <div className="flex justify-center h-screen items-center overflow-hidden">
      <div className="box lg:max-w-4xl">
        <div className={`cover ${isRegister ? "rotate-active" : ""}`}>
          <div className="front">
            ...
            <div className="text">
              <span className="text-1">
                Success is built upon well-organiized tasks
              </span>
          ...
          <div className="back">
            <img
              src="https://images.pexels.com/photos/12679942/pexels-photo-12679942.jpeg?auto=compress&cs=tinysrgb&w=1260&h=75dpr=1"
              alt=""
            />
          </div>
        </div>
